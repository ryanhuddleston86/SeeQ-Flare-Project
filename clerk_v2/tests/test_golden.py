...
def test_t5a_full_coverage_source_down_is_intersection():
    ...
    units = [AnalyzerUnit("NOx-P", "FCC", SeeqCovered=True),
             AnalyzerUnit("NOx-T", "FCC", SeeqCovered=True)]
    cells = _t5_grid()
    ...
    assert source_down_hours(units, cells) == {"FCC": [_h(12), _h(13)]}
